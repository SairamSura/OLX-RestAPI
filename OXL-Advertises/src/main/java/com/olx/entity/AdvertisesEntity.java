...
public class AdvertisesEntity {
	...
	public AdvertisesEntity(int id, String title, String description, double price, String category,
	...
	public String toString() {
		return "AdvertisesEntity [id=" + id + ", title=" + title + ", description=" + description + ", price=" + price
